...
class DataGenerator:
    ...
    def extract_data(self, max_num_obj, split=""):
        ...
        config=habitat.get_config("configs/objectnav_hm3d.yaml")
        ...
        for region in scene.regions:
            ...
            for obj in region.objects:
                ...
                if hm3d_category_name in mp3d_category_id and hm3d_category_name not in all_obj: 
            ...
            for goal in goal_list:
                temp_obj = all_obj
                self.objects.append(temp_obj.remove(goal))
